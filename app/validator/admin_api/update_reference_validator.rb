...
module AdminApi
  class UpdateReferenceValidator
    ...
    validate :required, :address_id_exist, :reference_id_exist, :valid_name, :valid_mobile, :valid_mobile_country_code_id, :valid_ref_position_id
    ...
    def reference_id_exist
      errors.add(:reference_id, NOT_FOUND) unless @reference
    end
