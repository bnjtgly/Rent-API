...
when 'development', 'staging'
  ...
  property3 = Property.create(agency_id: agency2.id, details: {
    ...
    desc: '',
    img: 'https://cdn.pixabay.com/photo/2016/11/18/17/46/house-1836070_960_720.jpg',
    address: 'Fourth Avenue, New Norfolk TAS, Australia',
    bedrooms: '4',
    bathrooms: '1',
    garage: '1',
  ...
  property4 = Property.create(agency_id: agency2.id, details: {
    ...
    desc: '',
    img: 'https://cdn.pixabay.com/photo/2017/06/16/15/58/luxury-home-2409518_960_720.jpg',
    address: 'Fourth Avenue, New Norfolk TAS, Australia',
    bedrooms: '3',
    bathrooms: '1',
    garage: '1',
